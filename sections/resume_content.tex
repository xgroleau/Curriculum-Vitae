        ...
        {Développeur embarqué principal}{Janvier 2022 - Aujourd'hui}{HOP Tech}{Sherbrooke, Qc}
            \resumeItemListStart
                ...
                \resumeItemEnFr
                    ...
                    {Optimiser et réduire la consommation de batterie de 65\%}
                \resumeItemEnFr
                    {Optimize and increase the data transfer rate by 25\%}
                    {Optimiser et augmenter la vitesse de transfert par 25\%}
                \resumeItemEnFr
                    {Optimize and reduce the logs size by 85\%}
                    {Optimiser et reduit l'espace des journaux (logs) par 85\%}  
                \resumeItemEnFr
