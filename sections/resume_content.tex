      ...
      \resumeSubheadingEnFr
        ...
        {Développeur embarqué principal}{Janvier 2022 - Septembre 2024}{HOP Tech}{Sherbrooke, Qc}
            \resumeItemListStart
                ...
                \resumeItemEnFr
                    {Oversee the development of the firmware in Rust for a Bluetooth wearable used in medical studies}
                    {Superviser le développement d'un firmware en Rust pour un wearable Bluetooth utilisé dans des études médicales}
                \resumeItemEnFr
